...
public abstract class ProtocolException extends Exception {
    ...
    public static class UnknownException extends ProtocolException {
		...
		public UnknownException(String response) {
			// super(String.format("Server response was not OK but status code is unknown. (\"%s\")", response));
	...
	public static class ProtocolVersionMismatchException extends ProtocolException {
		...
		public ProtocolVersionMismatchException(String serverVersion, String clientVersion) {
			// super(String.format("Server greeted with protocol version [%s] ours is [%s]"));
	...
	public static class ParseException extends ProtocolException {
		...
		public ParseException(Class<?> cls, String stringToParse) {
			// super(String.format("Could not parse \"%s\" as %s", stringToParse, cls));
            super(Status.PARSE_FAILED);
			this.cls = cls;
    ...
    public enum Status {
        ...
        DM_ALREADY_EXISTS, UNKNOWN_EXCEPTION, DEPRECATED_PROTOCOL_VERSION, PARSE_FAILED;
