...
public class ChatController implements Initializable {
    ...
    //    random messages, these are static messages just for demonstrating UI
...
//        Background bGround = new Background(bImg);
        ...
        userProfile.setFill(new ImagePattern(new Image(userProfileImage))); //i am taking static image here, it could be from db
...
//      adding event listener to new Friend button
        addUser.setOnMouseClicked(e -> {
            ...
            alert.setTitle("Add Friend"); // TODO: get user id from input field
            alert.setContentText("New Friend Added");
            alert.showAndWait();
        });
    }
